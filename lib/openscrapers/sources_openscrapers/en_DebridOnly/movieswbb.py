...
import urlparse
from openscrapers.modules import cleantitle, client, debrid, source_utils, log_utils, cfscrape
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['movieswbb.net/']
        self.base_link = 'http://movieswbb.net/'
            ...
            for option in options:
                for query_base in query_bases:
                    ...
                    if html.status_code == 200:
                        posts = client.parseDOM(html.content, "h2", attrs={"class": "title entry-title"})
                        for post in posts:
