...
import urlparse
from openscrapers.modules import client, source_utils, log_utils, debrid, cleantitle, cfscrape
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domain = 'filmrls.com'
        self.base_link = 'https://filmrls.com'
        ...
        self.search_options = '&search_start=0&full_search=1&result_from=1&titleonly=3&searchuser=&replyless=1' \
                              ...
                              '&catlist%5B%5D=61&catlist%5B%5D=1&catlist%5B%5D=3&catlist%5B%5D=4&catlist%5B%5D=5' \
                              '&catlist%5B%5D=6&catlist%5B%5D=7&catlist%5B%5D=9&catlist%5B%5D=11&catlist%5B%5D=12' \
                              '&catlist%5B%5D=16&catlist%5B%5D=17&catlist%5B%5D=18&catlist%5B%5D=19'
